...
units::meter_t SwerveModule::GetModuleDistance() {
  ...
  auto dist = (rotorPos / ModuleConstants::kDriveEncoderReduction) * ModuleConstants::kWheelCircum;
...
units::meters_per_second_t SwerveModule::GetModuleVelocity() {
  ...
  auto velocity = (rotorPos / ModuleConstants::kDriveEncoderReduction) * ModuleConstants::kWheelCircum;
...
void SwerveModule::SetDesiredState(
  ...
  const auto motor_vel = state.speed/ModuleConstants::kWheelCircum/ModuleConstants::kDriveEncoderReduction;
  m_driveMotor.SetControl(velocityControl.WithVelocity(motor_vel));
